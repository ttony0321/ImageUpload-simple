...
//
//                     <input
//                             accept="image/jpeg, image/png, image/gif" multiple="" type="file" autocomplete="off"
//                             tabindex="-1" name="myFile" class="drop-zone-input" style="display: none;">
//                     <div class="placeholder">
//                         <img class="hide" width="115" height="90" src="#" id="preview">
//                         <svg class="" id="preimage" width="115" height="90" viewBox="0 0 115 90" fill="none"
...
//                                   fill="#BDBDBD"/>
//                             <path d="M80.21 56.8114C93.0375 56.8114 103.436 46.4185 103.436 33.5981C103.436 20.7777 93.0375 10.3848 80.21 10.3848C67.3826 10.3848 56.9839 20.7777 56.9839 33.5981C56.9839 46.4185 67.3826 56.8114 80.21 56.8114Z"
//                                   fill="#95BDF4"/>
...
//                                   fill="#828282"/>
//                             <path d="M25.1431 80.4863H6.99368C6.91226 80.4861 6.83426 80.4536 6.77678 80.3959C6.71929 80.3382 6.68701 80.2601 6.68701 80.1787C6.68701 80.0973 6.71929 80.0192 6.77678 79.9615C6.83426 79.9039 6.91226 79.8713 6.99368 79.8711H25.1431C25.2247 79.8711 25.3029 79.9035 25.3606 79.9612C25.4183 80.0189 25.4507 80.0971 25.4507 80.1787C25.4507 80.2603 25.4183 80.3385 25.3606 80.3962C25.3029 80.4539 25.2247 80.4863 25.1431 80.4863V80.4863Z"
//                                   fill="#828282"/>
...
//                                   fill="#828282"/>
//                             <path d="M79.9014 80.4863H61.752C61.6706 80.4861 61.5926 80.4536 61.5351 80.3959C61.4776 80.3382 61.4453 80.2601 61.4453 80.1787C61.4453 80.0973 61.4776 80.0192 61.5351 79.9615C61.5926 79.9039 61.6706 79.8713 61.752 79.8711H79.9014C79.983 79.8711 80.0612 79.9035 80.1189 79.9612C80.1766 80.0189 80.209 80.0971 80.209 80.1787C80.209 80.2603 80.1766 80.3385 80.1189 80.3962C80.0612 80.4539 79.983 80.4863 79.9014 80.4863V80.4863Z"
//                                   fill="#828282"/>
...
//                                   fill="#828282"/>
//                             <path d="M100.183 57.791C106.411 52.1577 108.624 44.4589 105.125 40.5953C101.627 36.7318 93.7416 38.1665 87.5136 43.7999C81.2856 49.4333 79.0729 57.132 82.5714 60.9956C86.07 64.8591 93.9549 63.4244 100.183 57.791Z"
//                                   fill="#E6E6E6"/>
...
//                                   fill="#CCCCCC"/>
//                             <path d="M15.4465 68.1581C13.4733 66.3733 12.7722 63.9342 13.8806 62.7101C14.9891 61.486 17.4872 61.9406 19.4604 63.7254C21.4336 65.5102 22.1346 67.9493 21.0262 69.1734C19.9178 70.3975 17.4197 69.9429 15.4465 68.1581Z"
//                                   fill="#E6E6E6"/>
...
//                                   fill="#CCCCCC"/>
//                             <path d="M20.3164 63.1961C16.391 59.6455 14.9963 54.793 17.2014 52.3579C19.4064 49.9228 24.3762 50.8271 28.3016 54.3777C32.227 57.9283 33.6216 62.7807 31.4166 65.2158C29.2115 67.651 24.2418 66.7467 20.3164 63.1961Z"
//                                   fill="#E6E6E6"/>
...
//                                   fill="#CCCCCC"/>
//                             <path d="M39.2062 65.6837C42.2866 62.8973 43.3809 59.0894 41.6506 57.1785C39.9203 55.2675 36.0205 55.9772 32.9402 58.7635C29.8599 61.5498 28.7655 65.3577 30.4958 67.2687C32.2261 69.1796 36.1259 68.47 39.2062 65.6837Z"
//                                   fill="#E6E6E6"/>
...
//                         </svg>
//
//                         {#                        <span class="filename" style="color: rgb(169, 169, 169);">Drag &amp; Drop your image her</span>#}
//                     </div>
//                 </div>
//                 <span style="color: rgb(169, 169, 169);">or</span>
//                 <div class="fileUploadOption" id="fileUploadOption">
//                     <label for="submitBtn" style="background-color: #5cff88;">Upload file</label>
//                     <button type="submit"
//                             id="submitBtn"
//                             style="display: none;"></button>
//                     <label for="uploadBtn" onclick="uploadbtn()">Choose a file</label>
//                     <input type="file"
//                            id="uploadBtn"
//                            name="uploadBtn"
...
//                            style="display: none;"
//                            required
//                            onchange="setImageFromFile(this)">
//                 </div>
//
//             </form>
//             <div class="credentials">created by <a href="https://tousif-ahmed.netlify.app/" target="_blank"
//                                                    class="creator-name" rel="noreferrer">Tousif</a> - <a
//                     href="https://devchallenges.io/" target="_blank" class="challenger-name" rel="noreferrer">
//                 devChallenges.io</a></div>
//         </div>
//     </div>
